...
main(void)
{
	...
	vertexshader = compileshader("texex1shaders/flat.vert", GL_VERTEX_SHADER);
	fragmentshader = compileshader("texex1shaders/colors.frag", GL_FRAGMENT_SHADER);
	...
	uiloop(glGetUniformLocation(shaderprog, "blend"));
